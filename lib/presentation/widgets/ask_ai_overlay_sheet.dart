...
class AskAiOverlaySheet extends StatefulWidget {
  final String selectedText;
  final String bookTitle;

  const AskAiOverlaySheet({
    super.key,
  ...
  @override
  State<AskAiOverlaySheet> createState() => _AskAiOverlaySheetState();
}

class _AskAiOverlaySheetState extends State<AskAiOverlaySheet> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '"${widget.selectedText.length > 200 ? "${widget.selectedText.substring(0, 200)}..." : widget.selectedText}"',
                                  textDirection: TextDirection.rtl,
                                  style: const TextStyle(
                                    fontFamily: 'Amiri',
                                    fontSize: 16,
                          ...
                          // Input Row
                          _buildInputRow(context, state.isLoading),
                        ],
                      ),
                    ),
                  ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
            ...
            child: TextField(
              ...
              onSubmitted: isLoading
                  ...
                  : (value) {
                      ...
                      context.read<AskAiCubit>().askQuestion(
          ...
          Container(
            decoration: BoxDecoration(
              color: isLoading ? VintageTheme.inkFaded : VintageTheme.inkDark,
              borderRadius: BorderRadius.circular(12),
            ),
            child: IconButton(
